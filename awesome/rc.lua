...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        -- gears.wallpaper.centered(wallpaper, s, "#181621", .25)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            batteryarc_widget{
                low_level_color = "#F28FAD",
                medium_level_color = "#F8BD96",
                charging_color = "#ABE9B3"
            },
            brightness_widget{
                program="light"
            },
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "\\", function() volume_widget:toggle() end, {description = "mute", group = "custom"}),
...
-- autostart stuff
os.execute('xinput set-prop "SynPS/2 Synaptics TouchPad" "libinput Tapping Enabled" 1')
